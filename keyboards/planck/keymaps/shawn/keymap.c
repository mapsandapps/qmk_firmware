...
[0] = {
  ...
  {BL_STEP, KC_LCTL, KC_LALT, KC_LGUI, M(1),    KC_SPC,  KC_SPC,   M(2),   KC_RGUI, KC_RALT, KC_RCTL, KC_RSFT}
},
 ...
 * |      |      |   !  |   @  |   #  |      |      |   1  |   2  |   3  |Enter |   =  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Reset |      |      |      |      |    Space    |   0  |   0  |   .  |Enter |      |
 * `-----------------------------------------------------------------------------------'
 */
[1] = {
  {KC_TAB,  KC_GRV,  KC_AMPR, KC_ASTR, _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_PMNS, KC_BSPC},
  ...
  {RESET,   _______, _______, _______, _______, KC_SPC,  KC_SPC,  KC_0,    KC_0,    KC_DOT,  KC_PENT, _______}
},
 ...
 */
[2] = {
  {KC_TAB,  KC_TILD, _______, _______, _______, KC_LPRN, KC_RPRN, KC_PSLS, KC_UP,   KC_PAST, KC_UNDS, KC_BSPC},
